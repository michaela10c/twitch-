...
public class UserServiceTests {
    ...
    @Captor ArgumentCaptor<FavoriteRecordEntity> favoriteRecordEntityArgumentCaptor;
    ...
    public void setFavoriteItem_shouldCreateFavoriteRecord() {
        ...
        Mockito.verify(favoriteRecordRepository).save(favoriteRecordEntityArgumentCaptor.capture());
        FavoriteRecordEntity favorite = favoriteRecordEntityArgumentCaptor.getValue();
